        ...
        <table class="w-full min-w-[520px] text-left text-sm">
          ...
          <tbody class="divide-y divide-primary/20">
            ...
            >
              ...
              <td v-show="p.showBansRoleColumns" class="px-3 py-1 tabular-nums text-text/90">
                {{
                  p.banPctForCount(row.bansJungle, p.bansTableData?.matchCount ?? 0, 1).toFixed(2)
                }}%
                <div
              ...
              <td v-show="p.showBansRoleColumns" class="px-3 py-1 tabular-nums text-text/90">
                {{
                  p.banPctForCount(row.bansMiddle, p.bansTableData?.matchCount ?? 0, 1).toFixed(2)
                }}%
                <div
              ...
              <td v-show="p.showBansRoleColumns" class="px-3 py-1 tabular-nums text-text/90">
                {{
                  p.banPctForCount(row.bansBottom, p.bansTableData?.matchCount ?? 0, 1).toFixed(2)
                }}%
                <div
              ...
              <td v-show="p.showBansRoleColumns" class="px-3 py-1 tabular-nums text-text/90">
                {{
                  p.banPctForCount(row.bansSupport, p.bansTableData?.matchCount ?? 0, 1).toFixed(2)
                }}%
                <div
