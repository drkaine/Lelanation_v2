    ...
    >
      ...
      <div class="min-w-0 flex-1">
        <StatisticsChampionDetailLink
          ...
          class="inline-flex max-w-full items-center gap-2 rounded-sm"
        >
          ...
          />
          <span
            class="fast-stat-champion-card-name min-w-0 truncate text-sm font-medium text-accent underline decoration-accent/40 underline-offset-2"
          >
        ...
        <div v-if="row.label" class="fast-stat-champion-card-label text-[11px] text-text/55">
          {{ row.label }}
        </div>
      </div>
