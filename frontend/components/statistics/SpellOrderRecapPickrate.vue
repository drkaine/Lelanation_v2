<template>
  <div class="champion-spell-order-pickrate-block min-w-[4.5rem] text-right">
    ...
    <div class="mt-0.5 text-[9px] tabular-nums text-text/45">
      {{ t('statisticsPage.championSpellOrderGames', { count: games }) }}
    </div>
  </div>
</template>
