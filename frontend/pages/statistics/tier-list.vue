<template>
  <div class="statistics flex min-h-screen min-w-0 flex-col overflow-x-hidden text-text">
    ...
    <StatisticsFiltersPanel
      ...
      main-class="min-w-0 flex-1 p-4 max-lg:pb-20 lg:px-3 lg:pb-4 lg:pt-0"
    ...
    >
      <div class="statistics-filters-fields flex flex-col gap-3">
        ...
        <div
          v-if="tierListViewModel !== 'botlaneMatchups' && tierListViewModel !== 'botlaneDuoRank'"
        >
          <div class="mb-1 text-sm font-medium text-text">
      ...
      <template #main>
        <div class="w-full space-y-4">
          ...
          />
          <StatisticsBotlaneTierTab v-show="tierListViewModel === 'botlaneMatchups'" mode="vs" />
          <StatisticsBotlaneTierTab v-show="tierListViewModel === 'botlaneDuoRank'" mode="duo" />
        </div>
      </template>
    </StatisticsFiltersPanel>
  </div>
...
import StatisticsBotlaneTierTab from '~/components/statistics/tabs/StatisticsBotlaneTierTab.vue'
