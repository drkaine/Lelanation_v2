<template>
  <div class="home-page max-w-8xl mx-auto px-[10px] py-3 text-center text-text">
    <!-- Hero -->
    <section class="home-hero home-section mb-3">
      <h1 class="text-3xl font-bold leading-tight text-text-accent sm:text-4xl lg:text-5xl">
        {{ t('home.heroTitle') }}
      </h1>
      <p class="mx-auto mt-4 max-w-2xl text-base text-text/80 sm:text-lg">
        {{ t('home.heroSubtitle') }}
      </p>
    ...
    <section class="home-section mb-3">
      <p class="home-section-eyebrow mb-1.5 text-center">
        {{ t('home.followUs') }}
      </p>
    ...
    <section class="home-section mb-3">
      <div class="grid gap-2 sm:grid-cols-3">
        <div class="rounded-lg border border-primary/25 bg-surface/50 px-3 py-2 text-center">
          <p class="text-lg font-bold leading-tight text-accent">{{ formatStat(stats.builds) }}</p>
          <p class="mt-0.5 text-xs text-text/70">{{ t('home.statBuilds') }}</p>
        </div>
        <div class="rounded-lg border border-primary/25 bg-surface/50 px-3 py-2 text-center">
          <p class="text-lg font-bold leading-tight text-accent">{{ formatStat(stats.matches) }}</p>
          <p class="mt-0.5 text-xs text-text/70">
            {{ t('home.statPatchMatches', { patch: stats.patch }) }}
          </p>
        </div>
        <div class="rounded-lg border border-primary/25 bg-surface/50 px-3 py-2 text-center">
          <p class="text-lg font-bold leading-tight text-accent">{{ formatStat(stats.videos) }}</p>
