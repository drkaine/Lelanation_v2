...
function buildParticipantRow(
  ...
  const row: Record<string, unknown> = {
    ...
    damage_self_mitigated: ti(participant.damageSelfMitigated),
    ...
    magic_damage_dealt_to_champions: ti(participant.magicDamageDealtToChampions),
    ...
    physical_damage_dealt_to_champions: ti(participant.physicalDamageDealtToChampions),
    ...
    true_damage_dealt_to_champions: ti(participant.trueDamageDealtToChampions),
    ...
    for (const counts of eventCounts) {
      await tx.unsafe(
        `UPDATE participants SET
           ...
           death_by_roaming = $6,
           kill_on_objective = $7,
           death_on_objective = $8
         WHERE riot_match_id = $9 AND participant_id = $10`,
        [
          counts.killByDive,
          counts.deathByDive,
          counts.killByGank,
          ...
          counts.killByRoam,
          counts.deathByRoam,
          counts.killOnObjective,
          counts.deathOnObjective,
          matchId,
