...
const ROW_TO_SUM_METRIC: Record<string, string> = {
  ...
  physical_damage_dealt_to_champions: "sum_physical_damage_done_to_champions",
  magic_damage_dealt_to_champions: "sum_magic_damage_done_to_champions",
  true_damage_dealt_to_champions: "sum_true_damage_done_to_champions",
  damage_self_mitigated: "sum_damage_self_mitigated",
