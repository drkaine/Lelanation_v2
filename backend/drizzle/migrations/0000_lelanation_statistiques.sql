...
CREATE TABLE champion_spell_stats (
  ...
  spell_order_list INTEGER[] NOT NULL DEFAULT '{}', --[1, 2, 1, 3, 1, 4...] avec 1 Q spell 2 w spell 3 e spell 4 r
  sum_timestamp_ms BIGINT      NOT NULL DEFAULT 0,  -- somme des timestamps (ms) pour timing moyen de montée de sort
  count_game    INTEGER     NOT NULL DEFAULT 0,
  count_win     INTEGER     NOT NULL DEFAULT 0,
  updated_at    TIMESTAMPTZ NOT NULL DEFAULT NOW(),

  PRIMARY KEY (patch, role, rank_tier, region, champion_id)
);
...
CREATE TABLE champion_stats (
  ...
  sum_damage_taken_on_team_percentage BIGINT      NOT NULL DEFAULT 0,
  ...
  sum_kill_participation BIGINT      NOT NULL DEFAULT 0,
  ...
  sum_team_damage_percentage BIGINT      NOT NULL DEFAULT 0,
  ...
  sum_team_id BIGINT      NOT NULL DEFAULT 0,
