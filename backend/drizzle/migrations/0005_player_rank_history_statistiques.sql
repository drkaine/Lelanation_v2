-- lelanation_statistiques : historique de rang + table `players` allégée (colonnes rank / riot id retirées).
-- Le poller-v2 (`DATABASE_URL`) pointe en général vers cette base ; ne pas confondre avec lelanation_stats (Prisma).
